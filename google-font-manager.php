...
function myformatTinyMCE($tinyMce) {
    ...
    if($editorfonts) {
        ...
        $tinyMce['remove_linebreaks']=false;
        $tinyMce['gecko_spellcheck']=false;
        $tinyMce['keep_styles']=true;
        $tinyMce['accessibility_focus']=true;
        $tinyMce['tabfocus_elements']='major-publishing-actions';
        $tinyMce['media_strict']=false;
        $tinyMce['paste_remove_styles']=false;
        $tinyMce['paste_remove_spans']=false;
        $tinyMce['paste_strip_class_attributes']='none';
        $tinyMce['paste_text_use_dialog']=true;
        $tinyMce['wpeditimage_disable_captions']=true;
        $tinyMce['plugins']='inlinepopups,tabfocus,paste,media,fullscreen,wordpress,wpeditimage,wpgallery,wplink,wpdialogs,wpfullscreen';
        $tinyMce['content_css']=get_template_directory_uri() . "/editor-style.css";
        $tinyMce['wpautop']=true;
        $tinyMce['apply_source_formatting']=false;
        $tinyMce['theme_advanced_buttons1']='formatselect,fontselect,forecolor,|,bold,italic,underline,|,bullist,numlist,blockquote,|,justifyleft,justifycenter,justifyright,justifyfull,|,link,unlink,|,wp_fullscreen,wp_adv';
        ...
        $tinyMce['theme_advanced_buttons4']='';
        $tinyMce['theme_advanced_fonts']=$myfontlist;
        $tinyMce['content_css']=$mycsslist;
        return $tinyMce; 
    }
...
$editorfonts = get_option("wp_googlefontmgr_editorfonts", 1);    
if($editorfonts) { add_filter('tiny_mce_before_init', 'myformatTinyMCE'); }
...
register_deactivation_hook( dirname( __FILE__ ) .'/google-font-manager.php', 'wp_googlefontmgr_deactivate' );
